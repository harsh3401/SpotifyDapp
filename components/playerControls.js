...
const PlayerControls = ({ songs }) => {
  ...
  return (
    <div className={styles.mainControl}>
      ...
      <div>
        <div className={styles.controlIconsContainer}>
          <div className={styles.controlIcon}>
            <Image src={shuffle} alt="" unoptimized />
          </div>
          <div
          ...
          {isPaused ? (
            <div className={styles.playIcon} onClick={play}>
              <Image src={playRounded} alt="" unoptimized />
            </div>
          ) : (
            <div className={styles.pauseIconStyle} onClick={pause}>
              <Image src={pauseIcon} alt="" unoptimized />
            </div>
          )}
          ...
          <div className={styles.controlIcon}>
            <Image src={repeat} alt="" unoptimized />
          </div>
        </div>
        <div className={styles.flexCenter}>
      ...
      <div>
        <div className={styles.flexCenter}>
          <Image src={speaker} alt="" unoptimized />
          <input
            value={volume}
